                        ...
                        <div className="row">
                            ...
                            <div className="col">
                                ...
                                >
                                    ...
                                    <a href="https://archive.apache.org/dist/pinot/apache-pinot-0.12.1/apache-pinot-0.12.1-src.tar.gz">
                                        <div className="panel--title">
                                            Official source release
                                        </div>
                                    </a>
                                    <a href="https://archive.apache.org/dist/pinot/apache-pinot-0.12.1/apache-pinot-0.12.1-src.tar.gz.sha512">
                                        <div className="panel--subtitle">
                                            SHA512
                                        </div>
                                    </a>
                                    <a href="https://archive.apache.org/dist/pinot/apache-pinot-0.12.1/apache-pinot-0.12.1-src.tar.gz.asc">
                                        <div className="panel--subtitle">
                                            ASC
                                        </div>
                                    </a>

                                    <a href="https://archive.apache.org/dist/pinot/apache-pinot-0.12.1/apache-pinot-0.12.1-bin.tar.gz">
                                        <div className="panel--title">
                                            Binary download
                                        </div>
                                    </a>
                                    <a href="https://archive.apache.org/dist/pinot/apache-pinot-0.12.1/apache-pinot-0.12.1-bin.tar.gz.sha512">
                                        <div className="panel--subtitle">
                                            SHA512
                                        </div>
                                    </a>
                                    <a href="https://archive.apache.org/dist/pinot/apache-pinot-0.12.1/apache-pinot-0.12.1-bin.tar.gz.asc">
                                        <div className="panel--subtitle">
                                            ASC{" "}
                                        </div>
                                    </a>
