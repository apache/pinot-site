...
Apache Pinot is an open-source distributed OLAP datastore for user-facing and agent-facing real-time analytics, delivering sub-second queries on fresh data at very high concurrency. The goal of this website is to provide an informative, responsive, and engaging user experience to all community members.
