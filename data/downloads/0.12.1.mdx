...
officialSource:
    download: 'https://apachepinot.gateway.scarf.sh/pinot/0.12.1/apache-pinot-0.12.1-src.tar.gz'
...
binary:
    download: 'https://apachepinot.gateway.scarf.sh/pinot/0.12.1/apache-pinot-0.12.1-bin.tar.gz'
