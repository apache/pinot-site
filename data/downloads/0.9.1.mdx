...
officialSource:
    download: 'https://apachepinot.gateway.scarf.sh/pinot/0.9.1/apache-pinot-0.9.1-src.tar.gz'
...
binary:
    download: 'https://apachepinot.gateway.scarf.sh/pinot/0.9.1/apache-pinot-0.9.1-bin.tar.gz'
