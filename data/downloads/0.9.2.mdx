...
officialSource:
    download: 'https://apachepinot.gateway.scarf.sh/pinot/0.9.2/apache-pinot-0.9.2-src.tar.gz'
...
binary:
    download: 'https://apachepinot.gateway.scarf.sh/pinot/0.9.2/apache-pinot-0.9.2-bin.tar.gz'
