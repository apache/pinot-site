...
officialSource:
    download: 'https://apachepinot.gateway.scarf.sh/pinot/0.9.0/apache-pinot-0.9.0-src.tar.gz'
...
binary:
    download: 'https://apachepinot.gateway.scarf.sh/pinot/0.9.0/apache-pinot-0.9.0-bin.tar.gz'
