...
officialSource:
    download: 'https://apachepinot.gateway.scarf.sh/pinot/0.9.3/apache-pinot-0.9.3-src.tar.gz'
...
binary:
    download: 'https://apachepinot.gateway.scarf.sh/pinot/0.9.3/apache-pinot-0.9.3-bin.tar.gz'
