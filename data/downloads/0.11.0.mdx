...
officialSource:
    download: 'https://apachepinot.gateway.scarf.sh/pinot/0.11.0/apache-pinot-0.11.0-src.tar.gz'
...
binary:
    download: 'https://apachepinot.gateway.scarf.sh/pinot/0.11.0/apache-pinot-0.11.0-bin.tar.gz'
