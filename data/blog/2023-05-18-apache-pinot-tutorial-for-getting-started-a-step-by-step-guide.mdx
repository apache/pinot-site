...
![Download Docker image on Windows with PowerShell command window](https://startree.ai/wp-content/uploads/2024/08/1684419409-image7.png 'Download Docker image on Windows with PowerShell command window')
...
![Docker images command](https://startree.ai/wp-content/uploads/2024/08/1684420004-image3.png 'Docker images command')
...
```bash
docker run -it --entrypoint /bin/bash -p 9000:9000 apachepinot.docker.scarf.sh/apachepinot/pinot:0.12.0
```

![Running a container with downloaded Docker image](https://startree.ai/wp-content/uploads/2024/08/1684420103-image4.png 'Running a container with downloaded Docker image')
...
![VS Code Docker extension open to see container and content](https://startree.ai/wp-content/uploads/2024/08/1684421493-image11.png 'VS Code Docker extension open to see container and content')
...
![Running components, directory changed to bin folder and contents listed](https://startree.ai/wp-content/uploads/2024/08/1684421611-image10.png 'Running components, directory changed to bin folder and contents listed')
...
![Pinot data explorer](https://startree.ai/wp-content/uploads/2024/08/1684419932-image2.png 'Pinot data explorer')
...
![Apache Pinot tables created](https://startree.ai/wp-content/uploads/2024/08/1684421406-image12.png 'Apache Pinot tables created')
...
![Editing the .yaml file with Docker Desktop](https://startree.ai/wp-content/uploads/2024/08/1684419802-image1.png 'Editing the .yaml file with Docker Desktop')

You should now be able to see the table has been populated like so:

![Apache Pinot table populated](https://startree.ai/wp-content/uploads/2024/08/1684421215-image8.png 'Apache Pinot table populated')
...
![Apache Pinot query console](https://startree.ai/wp-content/uploads/2024/08/1684421163-image6.png 'Apache Pinot query console')
...
![Apache Pinot data on disk segment](https://startree.ai/wp-content/uploads/2024/08/1684421358-image9.png 'Apache Pinot data on disk segment')

Clicking on this gives the specifics of the segment:

![Segment specifics in Pinot UI](https://startree.ai/wp-content/uploads/2024/08/1684420155-image5.png 'Segment specifics in Pinot UI')
