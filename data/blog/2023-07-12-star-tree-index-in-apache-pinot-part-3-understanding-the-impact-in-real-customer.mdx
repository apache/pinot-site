...
![Visualization of the impact of start-tree index for an AdTech use case with Apache Pinot](/static/images/blogs/external/1689174701-image1.png)
...
![Visualization of the impact of star-tree index for a Cybersecurity use case with Apache Pinot](/static/images/blogs/external/1689175033-image4.png)
...
![Visualization of the impact of star-tree index for a Gaming use case with Apache Pinot](/static/images/blogs/external/1689175176-image2.png)

## Quick Recap: Star-Tree Index Performance Improvements

![Recap Table of the Impact that star-tree index had on three real-world customers using Apache Pinot™](/static/images/blogs/external/1689175271-image3.png)
