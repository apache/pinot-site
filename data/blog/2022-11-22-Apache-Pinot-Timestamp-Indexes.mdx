...
![Time in milliseconds with and without timestamp indexes bar chart](/static/images/blogs/external/1669133004-image1.png 'Time in milliseconds with and without timestamp indexes bar chart')
...
![Chicago crime dataset table schema](/static/images/blogs/external/1669132979-image3.png 'Chicago crime dataset table schema')
...
![Chicago crime dataset query result](/static/images/blogs/external/1669133027-image6.png 'Chicago crime dataset query result')

And, if we look above the query result, there’s metadata about the query, including the time that it took to run.

![Chicago crime dataset metadata about the query, including the time that it took to run](/static/images/blogs/external/1669133059-image5.png 'Chicago crime dataset metadata about the query, including the time that it took to run')
...
![Apache Pinot timestamp index on a column](/static/images/blogs/external/1669133112-image2.png 'Apache Pinot timestamp index on a column')
...
![Chicago crime dataset updated query stats](/static/images/blogs/external/1669133083-image4.png 'Chicago crime dataset updated query stats')
