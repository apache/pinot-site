...
![Primary data store transactions being replicated to a secondary data store](https://startree.ai/wp-content/uploads/2024/08/1684857872-image3.png 'Primary data store transactions being replicated to a secondary data store')
...
![WAL in a data store with new transactions appended to the end of the WAL](https://startree.ai/wp-content/uploads/2024/08/1684857250-image5.png 'WAL in a data store with new transactions appended to the end of the WAL')
...
![Diagram showing a Debezium connector reading the WAL and writing to a Debezium server](https://startree.ai/wp-content/uploads/2024/08/1684857201-image4.png 'Diagram showing a Debezium connector reading the WAL and writing to a Debezium server')
...
![Table describing the strategy and descriptions of stream ingestion with upsert](https://startree.ai/wp-content/uploads/2024/08/1684857317-image6.png 'Table describing the strategy and descriptions of stream ingestion with upsert')
