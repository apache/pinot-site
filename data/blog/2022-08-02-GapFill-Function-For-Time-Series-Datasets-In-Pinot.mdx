...
![Entities emitting data over time at irregular intervals](https://startree.ai/wp-content/uploads/2024/08/1661700264-entities-emitting-data.png 'Entities emitting data over time at irregular intervals')
...
![Sample parking lot dataset](https://startree.ai/wp-content/uploads/2024/08/1661700333-parking-data-table.png 'Sample parking lot dataset')
...
![Sample parking lot dataset with 30 minute time bucket](https://startree.ai/wp-content/uploads/2024/08/1661700377-30-min-bucket-example.png 'Sample parking lot dataset with 30 minute time bucket')
...
![Sample parking lot query workflow innermost SQL](https://startree.ai/wp-content/uploads/2024/08/1661700439-innermost-sql.png 'Sample parking lot query workflow innermost SQL')

The second most nested sql will gap fill the returned data as below:

![Sample parking lot query workflow second most SQL](https://startree.ai/wp-content/uploads/2024/08/1661700473-second-most.png 'Sample parking lot query workflow second most SQL')

The outermost query will aggregate the gapfilled data as follows:

![Sample parking lot query workflow outermost SQL](https://startree.ai/wp-content/uploads/2024/08/1661700517-outermost.png 'Sample parking lot query workflow outermost SQL')
...
![Gapfill steps](https://startree.ai/wp-content/uploads/2024/08/1661700601-gapfill-steps.png 'Gapfill steps')
...
![Sample query execution plan](https://startree.ai/wp-content/uploads/2024/08/1661700642-execution-plan.png 'Sample query execution plan')
...
![Sample server challenges graph](https://startree.ai/wp-content/uploads/2024/08/1661700716-challenges.png 'Sample server challenges graph')
