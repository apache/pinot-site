...
![PowerShell 7.3.4 docker run Apache Pinot](/static/images/blogs/external/1685462020-image1.png 'PowerShell 7.3.4 docker run Apache Pinot')
...
![Docker with container ID, Image, Command, and Created](/static/images/blogs/external/1685462274-image7.png 'Docker with container ID, Image, Command, and Created')

You can now browse to [http://localhost:9000/#/zookeeper](http://localhost:9000/#/zookeeper) to see the running cluster:

![Empty Zookeeper Browser](/static/images/blogs/external/1685462203-image5.png 'Empty Zookeeper Browser')
...
![Code with Apache Pinot speed results](/static/images/blogs/external/1685462322-image8.png 'Code with Apache Pinot speed results')
...
![Code with Apache Kafka](/static/images/blogs/external/1685462061-image2.png 'Code with Apache Kafka')

![Code with kafka version](/static/images/blogs/external/1685462480-image12.png 'Code with kafka version')
...
![Code with cd kafka](/static/images/blogs/external/1685462400-image10.png 'Code with cd kafka')
...
![Zookeeper Browser](/static/images/blogs/external/1685462099-image3.png 'Zookeeper Browser')
...
![Code with realtime](/static/images/blogs/external/1685462150-image4.png 'Code with realtime')
...
![Wikievents node in code](/static/images/blogs/external/1685462366-image9.png 'Wikievents node in code')

Navigate to the enwiki folder and review some of the downloaded JSON files.

![Code with realtime wikievents](/static/images/blogs/external/1685462441-image11.png 'Code with realtime wikievents')
...
![Zookeeper browser in Apache Pinot topics](/static/images/blogs/external/1685462510-image13.png 'Zookeeper browser in Apache Pinot topics')
...
![Apache Pinot query console](/static/images/blogs/external/1685462248-image6.png 'Apache Pinot query console')
