...
authors:
    - 'needham'
summary: Explore the INSERT INTO clause, which makes ingesting batch data into Pinot as easy as writing a SQL query.
...
![Sample data ingested into Apache Pinot from a S3 bucket](https://startree.ai/wp-content/uploads/2024/08/1668701275-image4.png 'Sample data ingested into Apache Pinot from a S3 bucket')
...
![Events schema table](https://startree.ai/wp-content/uploads/2024/08/1668701353-image1.png 'Events schema table')
...
![Sample imported records shown in the Apache Pinot Query Console menu](https://startree.ai/wp-content/uploads/2024/08/1668701512-image3.png 'Sample imported records shown in the Apache Pinot Query Console menu')
...
![Sample events_OFFLINE query result](https://startree.ai/wp-content/uploads/2024/08/1668701654-image5.png 'Sample events_OFFLINE query result')
...
![Checking the state of an ingestion job screen](https://startree.ai/wp-content/uploads/2024/08/1668701727-image2.png 'Checking the state of an ingestion job screen')
