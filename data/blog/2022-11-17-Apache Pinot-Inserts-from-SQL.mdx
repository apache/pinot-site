...
![Sample data ingested into Apache Pinot from a S3 bucket](/static/images/blogs/external/1668701275-image4.png 'Sample data ingested into Apache Pinot from a S3 bucket')
...
![Events schema table](/static/images/blogs/external/1668701353-image1.png 'Events schema table')
...
![Sample imported records shown in the Apache Pinot Query Console menu](/static/images/blogs/external/1668701512-image3.png 'Sample imported records shown in the Apache Pinot Query Console menu')
...
![Sample events_OFFLINE query result](/static/images/blogs/external/1668701654-image5.png 'Sample events_OFFLINE query result')
...
![Checking the state of an ingestion job screen](/static/images/blogs/external/1668701727-image2.png 'Checking the state of an ingestion job screen')
